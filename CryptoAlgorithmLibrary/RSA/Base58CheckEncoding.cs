...
namespace CryptoAlgorithmLibrary.RSA
{
    ...
    public static class Base58CheckEncoding
    {
        ...
        private static byte[] AddCheckSum(byte[] data)
        {
            ...
            var dataWithCheckSum = ArrayHelper.ConcatArrays(data, checkSum);
        ...
        {
            var result = ArrayHelper.SubArray(data, 0, data.Length - CHECK_SUM_SIZE);
            var givenCheckSum = ArrayHelper.SubArray(data, data.Length - CHECK_SUM_SIZE);
